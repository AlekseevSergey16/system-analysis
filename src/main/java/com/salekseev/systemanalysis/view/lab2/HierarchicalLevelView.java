...
public class HierarchicalLevelView extends ScrollPane {
    ...
    private GridPane createResultMatrixPane() {
        decompositionLabel = new Label("Иерархические уровни");
        ...
        resultMatrixPane.add(decompositionLabel, 0, 2);
        resultMatrixPane.add(incidentLabel, 0, 0);
        resultMatrixPane.add(subgraphMatrix, 0, 1);
